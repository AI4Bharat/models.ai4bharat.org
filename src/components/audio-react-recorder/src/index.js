...
export default class AudioReactRecorder extends React.Component {
  ...
  stop = () => {
    ...
    let interleaved = this.getLeftTrack(this.leftBuffer)
    ...
    view.setUint32(28, this.sampleRate * 2, true); // dwAvgBytesPerSec sampleRate *2 for 16 bit mono / sampleRate *4 for 16 bit stereo
