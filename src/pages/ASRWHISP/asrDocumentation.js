import { ASR_STREAMING_URLS, ASR_REST_URLS } from "../../config/config";

const ASR_STREAMING_URL = ASR_STREAMING_URLS["hi"];

const ASR_REST_URL = `${ASR_REST_URLS["hi"]}/asr/v1/recognize/${"hi"}`;
